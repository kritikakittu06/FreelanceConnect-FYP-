    ...
    <div class="min-h-screen min-w-[500px] flex items-center justify-center text-white">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mb-4">
                ...
                <x-text-input id="name" name="name" type="text" class="block mt-1 w-full border border-gray-500 rounded-md p-2 bg-gray-800 text-white" :value="old('name')" required autofocus autocomplete="name" />
            ...
            <div class="mb-4">
                ...
                <div class="relative">
                    <x-text-input id="email" name="email" type="email" class="block mt-1 w-full border border-gray-500 rounded-md p-2 bg-gray-800 text-white" :value="old('email')" required autocomplete="username" />
            ...
            <div class="mb-4">
                ...
                <div class="relative">
                    <x-text-input id="password" name="password" type="password" class="block mt-1 w-full border border-gray-500 rounded-md p-2 bg-gray-800 text-white" required autocomplete="new-password" />
            ...
            <div class="mb-4">
                ...
                <x-text-input id="password_confirmation" name="password_confirmation" type="password" class="block mt-1 w-full border border-gray-500 rounded-md p-2 bg-gray-800 text-white" required autocomplete="new-password" />
